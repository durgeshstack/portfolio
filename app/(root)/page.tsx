...
export const metadata: Metadata = {
  ...
  description:
    "Durgesh Kumar - Full Stack Developer specializing in React, Next.js, Node.js and scalable backend systems. Explore my projects including Beemasathi and Loan Management platforms.",
  alternates: {
        ...
        <div className="container  flex max-w-[64rem] flex-col items-center gap-4 text-center ">
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            ...
            I build scalable web applications using React, Next.js, Node.js
              and modern backend technologies. Passionate about creating
              efficient systems and great user experiences.
            </p>
          </div>
